...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PageInfo&&(identical(other.hasNextPage, hasNextPage) || other.hasNextPage == hasNextPage)&&(identical(other.endCursor, endCursor) || other.endCursor == endCursor));
}
...
/// Create a copy of PageInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? hasNextPage = null,Object? endCursor = null,}) {
  return _then(_self.copyWith(
hasNextPage: null == hasNextPage ? _self.hasNextPage : hasNextPage // ignore: cast_nullable_to_non_nullable
as bool,endCursor: null == endCursor ? _self.endCursor : endCursor // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _PageInfo implements PageInfo {
  const _PageInfo({required this.hasNextPage, required this.endCursor});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PageInfo&&(identical(other.hasNextPage, hasNextPage) || other.hasNextPage == hasNextPage)&&(identical(other.endCursor, endCursor) || other.endCursor == endCursor));
}
...
/// Create a copy of PageInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? hasNextPage = null,Object? endCursor = null,}) {
